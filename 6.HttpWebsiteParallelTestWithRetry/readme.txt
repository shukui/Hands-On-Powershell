...
6.If status code is not 200, which means response failure, will retry in a specified seconds.

Solution:
1.\lib\Get-HttpResponseResult.ps1 define function to handle parameters and http requese and response. If failure, will retry a few times.
